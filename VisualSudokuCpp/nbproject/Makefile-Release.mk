...
${OBJECTDIR}/DigitRecognizer.o: DigitRecognizer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DigitRecognizer.o DigitRecognizer.cpp
...
${TESTDIR}/tests/SudokuTests.o: tests/SudokuTests.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/SudokuTests.o tests/SudokuTests.cpp
...
${OBJECTDIR}/DigitRecognizer_nomain.o: ${OBJECTDIR}/DigitRecognizer.o DigitRecognizer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DigitRecognizer_nomain.o DigitRecognizer.cpp;\
	else  \
...
${OBJECTDIR}/Sudoku_nomain.o: ${OBJECTDIR}/Sudoku.o Sudoku.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sudoku_nomain.o Sudoku.cpp;\
	else  \
